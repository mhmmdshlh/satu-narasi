...
export const LearningPath = () => {
    return (
        <BaseBox>
            <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-6 text-center">Learning Path</h2>
            <p className="text-gray-700 text-center mb-8 text-base sm:text-lg">Jalur pembelajaran terstruktur untuk menjadi ahli
                kebijakan publik</p>
            <div className="flex flex-row items-center gap-1 sm:gap-2 overflow-x-auto pb-2">
                ...
                />
                <span className="text-xs sm:text-4xl text-red-500 font-black shrink-0">→</span>
                <LevelCard
                    variant="gray"
                    icon={faChartBar}
