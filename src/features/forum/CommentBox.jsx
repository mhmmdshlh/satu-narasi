        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-red-500 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-base">
                        {authorInitial}
                    </div>
                    <div>
            ...
            {isEditing ? (
                <form onSubmit={handleEditSubmit} className="ml-12 sm:ml-14 mt-2">
                    <textarea
                        value={editContent}
                ...
                <p className="text-gray-800 ml-12 sm:ml-14 whitespace-pre-wrap">{comment.content}</p>
            )}
        </div>
    );
};
