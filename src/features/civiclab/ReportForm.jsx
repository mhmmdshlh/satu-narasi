        ...
        <BaseBox>
            ...
            <div>
                {!user ? (
                    ...
                    <form onSubmit={handleSubmit} className="mb-10 min-h-[300px]">
                        {error && (
            ...
            {user && (reportsLoading || reports.length > 0) && (
                <div>
                        ...
                        <div className="space-y-4 animate-pulse">
                            {[1, 2].map(i => (
                                <div key={i} className="border-2 border-gray-200 rounded-xl p-5">
                                    ...
                                    <div className="h-36 bg-gray-200 rounded-lg mt-3" />
                                    <div className="h-4 bg-gray-200 rounded w-40 mt-3" />
                                </div>
                            ))}
                        </div>
                    ) : (
                            ...
                            return (
                                <div key={report.id} className="border-2 border-gray-200 rounded-xl p-5">
                                    ...
                                    <p className="text-gray-600 text-sm mt-3 line-clamp-2">{report.description}</p>
                                        {report.image_url && (
                                            <img src={report.image_url} alt="Foto laporan" width={288} height={144} className="mt-3 h-36 rounded-lg object-cover border border-gray-200" />
                                        )}
